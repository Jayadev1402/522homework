...
class CustomLRScheduler(_LRScheduler):
    ...
    def __init__(self, optimizer, last_epoch=-1, lr_factor=0.1, lr_patience=10):
        ...
        Args:
            ...
            lr_factor (float): The factor by which the learning rate will be reduced. Default: 0.1.
            lr_patience (int): The number of epochs with no improvement after which learning rate will be reduced. Default: 10.
